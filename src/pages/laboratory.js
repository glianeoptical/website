    ...
    return (
      <Layout>
        ...
        <p>
          ...
          Laboratory. Our state of the art laboratory will produce you RX with
          precision. Everyday hundreds of prescriptions are processed in our GH
          lab. Each order is quality inspected by our trained staff and sent to
          our retail and medical partners at the lowest price possible. Rest
          assured that both you and your patients are in good hands with GH
          Optical Laboratory.
        </p>
        ...
        <p>
          We distribute lenses and frame nationwide and abroad. We also offer
          bulk orders, online services and deliver orders the same day. Call us
          for inquiry Tel. <strong>(02) 2384999</strong> or{" "}
          <strong>09268752003</strong> or click <a href="#">here</a> to send us
          a message.
        </p>
        <h4>Lense Images</h4>
